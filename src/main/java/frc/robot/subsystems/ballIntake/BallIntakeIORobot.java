...
public class BallIntakeIORobot implements BallIntakeIO{
    ...
    public BallIntakeIORobot() {
        motor = new TalonFX(BALL_INTAKE_ID);
    ...
    @Override
    public boolean isLimitSwitchPressed(){ return limitSwitch.get();}

    @Override
    public void setDutyCycle(double dutyCycle) { motor.set(dutyCycle);}
}
