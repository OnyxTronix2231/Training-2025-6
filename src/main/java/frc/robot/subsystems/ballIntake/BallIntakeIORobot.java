...
import static frc.robot.subsystems.ballIntake.BallIntakeConstants.BALL_INTAKE_SWITCH_ID;
...
public class BallIntakeIORobot implements BallIntakeIO {
    ...
    public BallIntakeIORobot() {
        ...
        limitSwitch = new DigitalInput(BALL_INTAKE_SWITCH_ID);
    }
    ...
    public void updateInputs(ballIntakeInputs inputs) {
        ballIntakeMotorInputs.updateInputs();
        inputs.ballIntakeInput = ballIntakeMotorInputs;
    ...
    public double getCurrent() {
        return ballIntakeMotorInputs.getMotorStatorCurrentAmps();
    }
